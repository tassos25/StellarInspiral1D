...
!          b% s1% job% warn_run_star_extras = .false.
      ...
      integer function extras_binary_check_model(binary_id)
         ...
         ! Check weather overflowing L2/L3 point. Based on Pavloski & Ivanova 2015 ln(R_{L2/3}/R_L) = 0.27+- 0.01
         ! for q between 0.7 and 4. For q< 1 (not the case here) see equation 2 in Marchant et al 2016
         if (b% terminate_if_L2_overflow .and. b% rl_relative_gap(1) > 0.31) then
