...
!
! ***********************************************************************
      module POSYDON_run_binary_extras
         ...
         subroutine POSYDON_extras_binary_controls(binary_id, ierr)
            integer :: binary_id
         ...
         end subroutine POSYDON_extras_binary_controls
            ...
            ! Kudos to Francesca Valsecchi for help implementing and testing this
             ...
             if (has_convective_envelope) then
              ...
              ! New fitting E2 (Qin et al. 2018)
                ...
                if (is_nan(E2)) then  !maybe this won't be used.
                    k_div_T = 1d-20
                else
      ...
      !1                /(s% omega_avg_surf/(2d0*pi)), f_conv
         ...
         end module POSYDON_run_binary_extras
